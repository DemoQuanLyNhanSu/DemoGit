...
$sql="select * from nhanvien, luong where nhanvien.BacLuong=luong.BacLuong";
                    ...
                    <?php 
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $item->LCB ?></td>
                                <td><?php echo $item->HeSoLuong ?></td>
                                <td><?php echo $item->HeSoPhuCap ?></td>
                                <td>
                                    <a href="tinhluong.php?sid=<?php echo $item->Manv ?>" class="btn btn-sm btn-primary" >Tính lương</a>
                                </td>
                            </tr>
                    <?php
                    }
