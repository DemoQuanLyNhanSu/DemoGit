...
$sql="select * from nhanvien,phongban,chucvu,trinhdohv where nhanvien.MaPH=phongban.MaPH
and nhanvien.MaCV=chucvu.MaCV and nhanvien.Matdhv=trinhdohv.Matdhv and Hoten like ?";
$arrParam =[$t];
                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline">
                            <div class="input-group input-group-sm">
                                <input class="form-control form-control-navbar" type="search" name ="ten" placeholder="Search" aria-label="Search">
                    ...
                    <?php 
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $item->TenPH ?></td>
                                <td><?php echo $item->TenCV ?></td>
                                <td><?php echo $item->TenTD ?></td>
                                <td>
                                    <a href="employee_edit.php?sid=<?php echo $item->Manv ?>" class="btn btn-sm btn-primary" >Sửa</a>
                                    <a onclick="return confirm('Bạn có muốn xóa?');" href="employee_delete.php?sid=<?php echo $item->Manv ?>" class="btn btn-sm btn-danger btnDelete">Xóa</a>
                                </td>
                            </tr>
                    <?php
                    }
