    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                <span class="brand-text font-weight-light">QUẢN LÝ USER</span>
            </a>
            <div class="sidebar">
                    ...
                    <?php 
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="user_edit.php?sid=<?php echo $item->Email ?>" class="btn btn-sm btn-primary" >Sửa</a>
                                    <a onclick="return confirm('Bạn có muốn xóa?');" href="user_delete.php?sid=<?php echo $item->Email ?>" class="btn btn-sm btn-danger btnDelete">Xóa</a>
                                </td>
                            </tr>
                    <?php
                    }
